"""Durable GlobalSources read-only discovery records."""
...
class GlobalSourcesDiscoveryRequest(Base):
    __tablename__ = "intelligence_global_sources_discovery_requests"
    __table_args__ = (
        UniqueConstraint(
    ...
    provider: Mapped[str] = mapped_column(String(32), default="GLOBAL_SOURCES")
...
class GlobalSourcesDiscoveryResult(Base):
    __tablename__ = "intelligence_global_sources_discovery_results"
    __table_args__ = (
        UniqueConstraint(
    ...
    request_id: Mapped[uuid.UUID] = mapped_column(
        UUID(as_uuid=True),
        ForeignKey("intelligence_global_sources_discovery_requests.id", ondelete="CASCADE"),
        index=True,
    )
