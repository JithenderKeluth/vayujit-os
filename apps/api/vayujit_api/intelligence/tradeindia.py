"""TradeIndia read-only provider adapter with deterministic local fixtures."""
...
def provider_preflight(settings: Settings) -> dict[str, object]:
    if (
        ...
        or settings.tradeindia_kill_switch
    ):
        status = "KILL_SWITCHED"
    elif settings.tradeindia_mode == "DISABLED" or not settings.tradeindia_enabled:
        status = "DISABLED"
    elif settings.tradeindia_mode == "LOCAL_FIXTURE":
        status = "READY"
    else:
    ...
    return {
        ...
        "status": status,
        "credentials_configured": bool(settings.tradeindia_token_ref),
...
def discover_local(
    *, query: str, limit: int, country_code: str | None, fixture_case: str | None = None
    ...
    common = "TradeIndia Local Fixture Manufacturing"
    values = [
        TradeIndiaListing(
            f"local-{digest}-001",
            common,
            f"{title} factory listing",
            f"https://www.tradeindia.com/local-fixture/{digest}/001",
        ...
        TradeIndiaListing(
            f"local-{digest}-002",
            "TradeIndia Local Fixture Components",
            f"{title} components listing",
            f"https://www.tradeindia.com/local-fixture/{digest}/002",
            "Delhi, Delhi, IN",
            query[:120] or None,
            None,
            None,
        ...
        TradeIndiaListing(
            ...
            f"https://www.tradeindia.com/local-fixture/{digest}/003",
            "Mumbai, Maharashtra, IN",
            query[:120] or None,
            22.0,
            None,
        ...
        TradeIndiaListing(
            ...
            f"https://www.tradeindia.com/local-fixture/{digest}/004",
            "Mumbai, Maharashtra, IN",
            query[:120] or None,
            19.0,
            "USD",
        ...
        TradeIndiaListing(
            ...
            f"https://www.tradeindia.com/local-fixture/{digest}/005",
            None,
            query[:120] or None,
            20.0,
            "USD",
        ...
        TradeIndiaListing(
            ...
            f"https://www.tradeindia.com/local-fixture/{digest}/006",
            "Maharashtra, IN",
            query[:120] or None,
            21.0,
            "USD",
        ...
        TradeIndiaListing(
            f"local-{digest}-007",
            "TradeIndia Local Fixture Trading",
            "UNKNOWN",
            f"https://www.tradeindia.com/local-fixture/{digest}/007",
            "Gujarat, IN",
            None,
            17.0,
            "USD",
        ...
        TradeIndiaListing(
            ...
            f"https://www.tradeindia.com/local-fixture/{digest}/008",
            "Mumbai, Maharashtra, IN",
            query[:120] or None,
            19.5,
            "USD",
        ...
        TradeIndiaListing(
            f"local-{digest}-009",
            "TradeIndia Local Fixture Manufacturings",
            f"{title} similar supplier listing",
            f"https://www.tradeindia.com/local-fixture/{digest}/009",
            "Mumbai, Maharashtra, IN",
            query[:120] or None,
            18.0,
            "USD",
        ...
        TradeIndiaListing(
            ...
            f"https://www.tradeindia.com/local-fixture/{digest}/010",
            "Mumbai, Maharashtra, IN",
            query[:120] or None,
            18.5,
            "USD",
        ...
        TradeIndiaListing(
            ...
            f"https://www.tradeindia.com/local-fixture/{digest}/011",
            "Mumbai, Maharashtra, IN",
            query[:120] or None,
            26.0,
            "USD",
        ...
        TradeIndiaListing(
            ...
            f"https://www.tradeindia.com/local-fixture/{digest}/012",
            "Mumbai, Maharashtra, IN",
            None,
            None,
            None,
        ...
        TradeIndiaListing(
            ...
            f"https://www.tradeindia.com/local-fixture/{digest}/013",
            "Tamil Nadu, IN",
            query[:120] or None,
            16.0,
            "USD",
    ...
    values.extend(
        [
            TradeIndiaListing(
                ...
                f"https://www.tradeindia.com/local-fixture/{digest}/014",
                "Mumbai, Maharashtra, IN",
                query[:120] or None,
                31.0,
                "INR",
            ...
            TradeIndiaListing(
                ...
                f"https://www.tradeindia.com/local-fixture/{digest}/015",
                "Mumbai, Maharashtra, IN",
                query[:120] or None,
                18.5,
                "INR",
                ...
                "unknown",
                "provider_claimed",
                {**_metadata("stale_commercial_observation", country_code), "freshness": "stale"},
            ),
        ]
    )
    if fixture_case:
