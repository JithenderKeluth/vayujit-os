"""Durable Alibaba read-only discovery records."""
...
class AlibabaDiscoveryRequest(Base):
    __tablename__ = "intelligence_alibaba_discovery_requests"
    __table_args__ = (
        UniqueConstraint(
    ...
    provider: Mapped[str] = mapped_column(String(32), default="ALIBABA")
...
class AlibabaDiscoveryResult(Base):
    __tablename__ = "intelligence_alibaba_discovery_results"
    __table_args__ = (
        UniqueConstraint(
    ...
    request_id: Mapped[uuid.UUID] = mapped_column(
        UUID(as_uuid=True),
        ForeignKey("intelligence_alibaba_discovery_requests.id", ondelete="CASCADE"),
        index=True,
    )
