...
class Settings(BaseSettings):
    ...
    indiamart_enabled: bool = False
    indiamart_mode: Literal["DISABLED", "LOCAL_FIXTURE", "LIVE_READ_ONLY"] = "DISABLED"
    indiamart_base_url: str | None = None
    indiamart_token_ref: str | None = None
