"""Add Slice 9D supplier and sourcing feasibility outputs."""
...
revision = "20261103_0112"
down_revision = "20261102_0111"
branch_labels = None
depends_on = None
...
def upgrade() -> None:
    op.create_table(
        "intelligence_product_opportunity_sourcing_feasibility_outputs",
        ...
        sa.Column("upstream_lineage", JSONB, nullable=False),
    ...
    op.create_index(
        "ix_product_opportunity_feasibility_owner",
        "intelligence_product_opportunity_sourcing_feasibility_outputs",
        ["owner_id"],
    )
    op.create_index(
        "ix_product_opportunity_feasibility_opportunity",
        "intelligence_product_opportunity_sourcing_feasibility_outputs",
        ["opportunity_id", "assessment_id"],
    )
    op.create_index(
        "ix_product_opportunity_feasibility_assessment",
        "intelligence_product_opportunity_sourcing_feasibility_outputs",
        ["assessment_id"],
    )
    op.create_index(
        "ix_product_opportunity_feasibility_created",
        "intelligence_product_opportunity_sourcing_feasibility_outputs",
        ["created_at"],
    )
...
def downgrade() -> None:
    op.drop_index(
        "ix_product_opportunity_feasibility_created",
        table_name="intelligence_product_opportunity_sourcing_feasibility_outputs",
    )
    op.drop_index(
        "ix_product_opportunity_feasibility_assessment",
        table_name="intelligence_product_opportunity_sourcing_feasibility_outputs",
    ...
    op.drop_table("intelligence_product_opportunity_sourcing_feasibility_outputs")
