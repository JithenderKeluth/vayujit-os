...
Discovery accepts an existing Product reference or ProductOpportunity reference plus market, category, cost, MOQ, lead-time, country, private-label, customization, certification, and risk requirements.
