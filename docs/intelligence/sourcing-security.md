...
All sourcing records are owner-scoped. Inputs are bounded, untrusted text is rendered safely, and responses never expose credentials, DSNs, tokens, SQL, or local paths.
