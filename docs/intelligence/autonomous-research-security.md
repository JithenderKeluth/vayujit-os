# Autonomous research security

The kill switch is the external research configuration flag. Local deterministic execution remains available for safe certification. All mission, task, evidence, recovery, report, and alert records are owner-scoped. Responses omit credentials, tokens, cookies, local paths, SQL, and tracebacks.
