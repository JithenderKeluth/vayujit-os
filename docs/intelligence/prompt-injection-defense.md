...
Fetched or imported text is classified as untrusted external data, sanitized for HTML, and never treated as executable instructions. Tool permissions exclude shell, arbitrary filesystem, raw SQL, email, payments, and external mutations.
