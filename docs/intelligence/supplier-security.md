...
The dedicated parameterized suite executes 70 cases, including unsafe URL targets, private/link-local/metadata IPs, embedded credentials, cross-owner boundaries, XSS payloads, historical overwrite attempts, currency/quantity bounds, duplicate identities, and response-secret leakage checks.
