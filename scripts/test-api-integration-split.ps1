...
$groups = @{
  ...
  commerce = @('tests/test_commerce_integration.py', 'tests/test_amazon_integration.py', 'tests/test_flipkart_integration.py', 'tests/test_meesho_integration.py', 'tests/test_cross_marketplace_e2e.py', 'tests/test_three_marketplace_e2e.py')
