param(
  [string[]]$TestPath = @(
    "tests/test_tradeindia_discovery.py",
    "tests/test_tradeindia_integration.py",
    "tests/test_tradeindia_hard_gate.py"
  )
)
...
$env:VAYUJIT_TRADEINDIA_ENABLED = "true"
$env:VAYUJIT_TRADEINDIA_MODE = "LOCAL_FIXTURE"
